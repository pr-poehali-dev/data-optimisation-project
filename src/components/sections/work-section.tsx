      ...
      sections: [
        {
          ...
          items: [
            "**Встать на учёт в женскую консультацию до 12 недель** — чем раньше, тем лучше",
            ...
            "Подготовить документы: **паспорт, полис ОМС, обменная карта** — без них не примут",
          ],
        },
        {
          ...
          items: [
            ...
            "🧴 **Гигиена:** прокладки послеродовые (5–6 упаковок), одноразовые трусы (10–15 шт.), **крем для сосков Бепантен**, влажные салфетки",
            "👗 **Одежда маме:** ночная рубашка для родов (тёмная), халат, тапочки, **бюстгальтер для кормления** (2–3 шт.), компрессионные чулки",
            "👶 **Малышу:** боди (3–5 шт.), ползунки (3–5 шт.), шапочки (2–3 шт.), **подгузники новорождённый размер** (1 упаковка)",
            "🍼 Для кормления: прокладки для груди, молокоотсос (по желанию)",
            "📱 **Телефон + зарядка** — обязательно, наушники, небольшой перекус",
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Лучшее время для укладывания: 19:00–20:00** — при первых признаках усталости (зевота, потирание глаз)",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Обратиться к врачу:** терапевт или психиатр поставят диагноз и назначат лечение",
